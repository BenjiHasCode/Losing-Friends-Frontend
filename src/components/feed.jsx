            ...
            <div className='post'> 
                <div className='poster'>
                    <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
                        <Avatar alt="Remy Sharp" src="https://mui.com/static/images/avatar/1.jpg" sx={{mr: 1, my: 0.5}}/>
                        <TextField id="post-input" label="Share your thoughts" variant="standard"/>
                        <div className='post-button'>
                            <Button className='post-button' onClick={this.props.onClick}>Post</Button>
                        </div>
                    </Box>
                </div>    
            </div>
...
class Feed extends React.Component {
    ...
    render() {
        const feed = this.state.feedItems;
